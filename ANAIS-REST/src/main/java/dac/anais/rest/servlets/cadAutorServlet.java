 ...
 * @author viter
 */
@WebServlet(name = "cadAutorServlet", urlPatterns = {"/cadAutorServlet"})
public class cadAutorServlet extends HttpServlet {
     ...
     */
     protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            WebTarget wt = webTarget.path("resources/autor");
            ...
            JsonObject obj = builder.add("id", request.getParameter("id"))
                    .add("nome",request.getParameter("nome"))
                    .add("nomemeio",request.getParameter("nomemeio"))
                    .add("sobrenome",request.getParameter("sobrenome"))
                    .add("email",request.getParameter("dtinicio"))
                    .add("pais", request.getParameter("pais"))
                    .add("registro",request.getParameter("registro")) 
                    .add("afiliacao",request.getParameter("afiliacao")) 
                    .add("afiliacaoEN",request.getParameter("afiliacaoEN")) 
                    .add("ordArtigo",request.getParameter("ordArtigo")) 
                    .build();
            ...
            Logger.getLogger(cadAutorServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>API Cadastra Autor</title>");
            out.println("</head>");
            out.println("<body>");
